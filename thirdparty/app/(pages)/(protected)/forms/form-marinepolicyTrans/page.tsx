...
useEffect(() => {
  const fetchData = async () => {
    try {
      ...
      const response = await axios.get(`${server}noor_takaful_service/api/generate_marine_certificate_external_post/${id}`);
...
const handleSubmit = async (e) => {
  ...
  try {
    const response = await axios.post(`${server}noor_takaful_service/api/generate_marine_certificate_external_post/certificate/${id}`, formData, {
